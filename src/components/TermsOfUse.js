...
const TermsOfUse = () => {
  useEffect(() => {
    ...
    const questions = [
        {
            question:"1. Description of Service and Acceptance of Terms of Use",
        ...
        {
            question:"2. Subscription Services",
